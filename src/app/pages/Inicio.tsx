    ...
    <div className="max-w-3xl mx-auto">
      <div className="mb-8 md:mb-10">
        ...
        <h1 className="text-2xl md:text-3xl lg:text-4xl mb-3 leading-tight">
          Observe o que normalmente passa despercebido.
        </h1>
      ...
      <div className="grid grid-cols-3 gap-2 md:gap-3 mb-8 md:mb-10">
        <Card className="text-center py-3 md:py-4">
          ...
          <p className="text-[10px] md:text-xs text-muted-foreground mt-0.5">observações</p>
        </Card>
        <Card className="text-center py-3 md:py-4">
        ...
        <Card className="text-center py-3 md:py-4">
          ...
          <p className="text-[10px] md:text-xs text-muted-foreground mt-0.5">alta intensidade</p>
        </Card>
      </div>

      <div className="mb-8 md:mb-10">
        <div className="flex items-center justify-between mb-3 md:mb-4">
          <h2 className="text-base md:text-lg">Observações recentes</h2>
          {atritos.length > 0 && (
            <button
              onClick={() => navigate('/atritos')}
              className="text-xs text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1 active:scale-95"
            >
                ...
                <Card className="py-3 px-4 hover:border-border transition-all">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <span className="text-[11px] text-muted-foreground capitalize hidden md:inline">{atrito.context}</span>
      ...
      <div className="border-t border-border/50 pt-6 pb-4">
