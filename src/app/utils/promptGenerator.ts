...
function templateMvpDefinition(): string {
  return [
    ...
    '',
    'Defina um produto mínimo viável que valide a hipótese central da oportunidade.',
    '',
...
function templateTechnicalIssue(): string {
  return [
    ...
    '- Inclua dados relevantes do atrito e da oportunidade.',
    '',
    '### Problema',
...
function templateOpportunityValidation(): string {
  return [
    '## Sua tarefa: Validar oportunidade',
    '',
    'Avalie o potencial desta oportunidade e sugira próximos passos concretos.',
    '',
    ...
    '- Sugira 2-3 formas baratas e rápidas de validar a oportunidade antes de construir.',
